...
# Settings
city = "Barcelona" # Your town
api_key = "0ce6f142be48e3bb881a8a901e8c5261" # Your openweather api key
...
def main():
    try:
        ...
        if(result.status_code == requests.codes['ok']):
                ...
                return icons_list[icon] + '%{F${colors.text}' + '{}°{}'.format(temp, temperature_unit) + '%{F-}'
        else:
